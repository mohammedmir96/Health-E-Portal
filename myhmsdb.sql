...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 22, 2022 at 03:43 AM
...
(17, 26, 'Rajat', 'Mohanty', 'Male', 'rajatmohanty64@gmail.com', '7008362766', 'Jack', 750, '2022-11-20', '12:00:00', 1, 1);
...
INSERT INTO `contact` (`name`, `email`, `contact`, `doctor`, `message`) VALUES
...
('Rajat Mohanty', 'rajatmohanty64@gmail.com', '7008362766', 'Jack', 'Good Service'),
('Rajat Mohanty', 'rajatmohanty64@gmail.com', '7008362766', 'Jack', 'Good Service');
...
CREATE TABLE `doctb` (
  ...
  `hosAddress` varchar(55) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `doctb` (`username`, `password`, `email`, `spec`, `docFees`, `hosAddress`) VALUES
...
(12, 'abc', 'def', 'Male', 'abc@gmail.com', '1234567890', '', '12345678', '12345678'),
(17, 'Rajat', 'Mohanty', 'Male', 'rajatmohanty64@gmail.com', '7008362766', 'VSS NAGAR,BBSR', '239516146', '239516146');
...
('Jack', 16, 24, 'Rajat', 'Mohanty', '2022-11-20', '16:00:00', 'Cold', 'No', '1 Cold medicine');
